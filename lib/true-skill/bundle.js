...
// node_modules/.pnpm/typed-function@4.1.1/node_modules/typed-function/lib/umd/typed-function.js
var require_typed_function = __commonJS({
  "node_modules/.pnpm/typed-function@4.1.1/node_modules/typed-function/lib/umd/typed-function.js"(exports, module) {
    (function(global, factory2) {
      ...
      function create() {
        ...
        function findType(typeName) {
          ...
          const name40 = typeName.toLowerCase();
          let otherName;
          for (otherName of typeList) {
            if (otherName.toLowerCase() === name40) {
        ...
        function findTypeNames(value) {
          const matches = typeList.filter((name40) => {
            const type = typeMap.get(name40);
        ...
        function findSignature(fn, signature, options) {
          ...
          if (exact) {
            remainingSignatures = [];
            let name40;
            for (name40 in fn.signatures) {
              remainingSignatures.push(fn._typedFunctionData.signatureMap.get(name40));
            }
          } else {
        ...
        function mergeExpectedParams(signatures, index) {
          ...
          signatures.forEach((signature) => {
            ...
            let name40;
            for (name40 of paramSet) {
              typeSet.add(name40);
            }
          });
          return typeSet.has("any") ? ["any"] : Array.from(typeSet);
        }
        function createError(name40, args, signatures) {
          let err, expected;
          const _name = name40 || "unnamed";
        ...
        function conflicting(params1, params2) {
          ...
          for (let i = 0; i < ii; i++) {
            ...
            let overlap = false;
            let name40;
            for (name40 of typeSet2) {
              if (typeSet1.has(name40)) {
                overlap = true;
                break;
              }
            }
        ...
        function createTypedFunction(name40, rawSignaturesMap) {
          typed2.createCount++;
          ...
          const generic = function generic2() {
            ...
            return typed2.onMismatch(name40, arguments, signatures);
          };
        ...
        function _onMismatch(name40, args, signatures) {
          throw createError(name40, args, signatures);
        }
        ...
        function getObjectName(obj) {
          ...
          for (const key in obj) {
            if (Object.prototype.hasOwnProperty.call(obj, key) && (isTypedFunction(obj[key]) || typeof obj[key].signature === "string")) {
              name40 = checkName(name40, obj[key].name);
            }
          }
          return name40;
        }
        ...
        typed2 = function(maybeName) {
          ...
          for (let i = start; i < arguments.length; ++i) {
            ...
            if (!named) {
              name40 = checkName(name40, thisName);
            }
            mergeSignatures(allSignatures, theseSignatures);
          }
          return createTypedFunction(name40 || "", allSignatures);
        };
...
// node_modules/.pnpm/complex.js@2.1.1/node_modules/complex.js/complex.js
var require_complex = __commonJS({
  "node_modules/.pnpm/complex.js@2.1.1/node_modules/complex.js/complex.js"(exports, module) {
    (function(root) {
      "use strict";
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/core/config.js
var DEFAULT_CONFIG = {
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/utils/is.js
function isNumber(x) {
  return typeof x === "number";
}
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/utils/object.js
function clone(x) {
  var type = typeof x;
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/core/function/config.js
var MATRIX_OPTIONS = ["Matrix", "Array"];
var NUMBER_OPTIONS = ["number", "BigNumber", "Fraction"];

// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/entry/configReadonly.js
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/core/function/typed.js
var import_typed_function = __toESM(require_typed_function(), 1);

// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/utils/number.js
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/utils/bignumber/formatter.js
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/utils/string.js
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/error/DimensionError.js
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/error/IndexError.js
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/utils/array.js
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/utils/factory.js
function factory(name40, dependencies40, create, meta) {
  function assertAndCreate(scope) {
    var deps = pickShallow(scope, dependencies40.map(stripOptionalNotation));
    assertDependencies(name40, dependencies40, scope);
    return create(deps);
  }
  assertAndCreate.isFactory = true;
  assertAndCreate.fn = name40;
  assertAndCreate.dependencies = dependencies40.slice().sort();
  if (meta) {
    assertAndCreate.meta = meta;
  }
  return assertAndCreate;
}
function assertDependencies(name40, dependencies40, scope) {
  var allDefined = dependencies40.filter((dependency) => !isOptionalDependency(dependency)).every((dependency) => scope[dependency] !== void 0);
  if (!allDefined) {
    var missingDependencies = dependencies40.filter((dependency) => scope[dependency] === void 0);
    throw new Error('Cannot create function "'.concat(name40, '", ') + "some dependencies are missing: ".concat(missingDependencies.map((d) => '"'.concat(d, '"')).join(", "), "."));
  }
}
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/utils/customs.js
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/utils/map.js
...
var createTyped = /* @__PURE__ */ factory("typed", dependencies, function createTyped2(_ref) {
  ...
  typed2.onMismatch = (name40, args, signatures) => {
    var usualError = typed2.createError(name40, args, signatures);
    ...
    signatures.some((sig) => !sig.params.includes(","))) {
      var err = new TypeError("Function '".concat(name40, "' doesn't apply to matrices. To call it ") + "elementwise on a matrix 'M', try 'map(M, ".concat(name40, ")'."));
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/type/bignumber/BigNumber.js
var name = "BigNumber";
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/type/complex/Complex.js
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/type/fraction/Fraction.js
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/type/matrix/Matrix.js
var name4 = "Matrix";
var dependencies5 = [];
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/utils/function.js
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/type/matrix/DenseMatrix.js
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/utils/collection.js
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/function/utils/isInteger.js
var name6 = "isInteger";
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/plain/number/arithmetic.js
var n1 = "number";
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/plain/number/utils.js
var n12 = "number";
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/function/utils/isZero.js
var name7 = "isZero";
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/utils/bignumber/nearlyEqual.js
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/utils/complex.js
function complexEquals(x, y, epsilon) {
  return nearlyEqual(x.re, y.re, epsilon) && nearlyEqual(x.im, y.im, epsilon);
}

// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/function/relational/compareUnits.js
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/function/relational/equalScalar.js
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/type/matrix/SparseMatrix.js
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/type/number.js
var name10 = "number";
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/type/bignumber/function/bignumber.js
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/type/fraction/function/fraction.js
var name12 = "fraction";
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/type/matrix/function/matrix.js
var name13 = "matrix";
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/function/arithmetic/unaryMinus.js
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/function/arithmetic/abs.js
var name15 = "abs";
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/function/arithmetic/addScalar.js
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/function/arithmetic/subtractScalar.js
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/type/matrix/utils/matAlgo11xS0s.js
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/type/matrix/utils/matAlgo14xDs.js
var name19 = "matAlgo14xDs";
var dependencies20 = ["typed"];
var createMatAlgo14xDs = /* @__PURE__ */ factory(name19, dependencies20, (_ref) => {
  var {
    typed: typed2
  } = _ref;
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/function/arithmetic/exp.js
var name20 = "exp";
var dependencies21 = ["typed"];
var createExp = /* @__PURE__ */ factory(name20, dependencies21, (_ref) => {
  var {
    typed: typed2
  } = _ref;
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/type/matrix/utils/matAlgo13xDD.js
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/type/matrix/utils/broadcast.js
var name22 = "broadcast";
var dependancies = ["concat"];
var createBroadcast = /* @__PURE__ */ factory(name22, dependancies, (_ref) => {
  var {
    concat: concat3
  } = _ref;
  return function(A, B) {
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/type/matrix/utils/matrixAlgorithmSuite.js
var name23 = "matrixAlgorithmSuite";
var dependencies23 = ["typed", "matrix", "concat"];
var createMatrixAlgorithmSuite = /* @__PURE__ */ factory(name23, dependencies23, (_ref) => {
  var {
    typed: typed2,
    matrix: matrix2,
    concat: concat3
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/type/matrix/utils/matAlgo01xDSid.js
var name24 = "matAlgo01xDSid";
var dependencies24 = ["typed"];
var createMatAlgo01xDSid = /* @__PURE__ */ factory(name24, dependencies24, (_ref) => {
  var {
    typed: typed2
  } = _ref;
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/type/matrix/utils/matAlgo04xSidSid.js
var name25 = "matAlgo04xSidSid";
var dependencies25 = ["typed", "equalScalar"];
var createMatAlgo04xSidSid = /* @__PURE__ */ factory(name25, dependencies25, (_ref) => {
  var {
    typed: typed2,
    equalScalar: equalScalar2
  } = _ref;
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/type/matrix/utils/matAlgo10xSids.js
var name26 = "matAlgo10xSids";
var dependencies26 = ["typed", "DenseMatrix"];
var createMatAlgo10xSids = /* @__PURE__ */ factory(name26, dependencies26, (_ref) => {
  var {
    typed: typed2,
    DenseMatrix: DenseMatrix2
  } = _ref;
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/function/arithmetic/multiplyScalar.js
var name27 = "multiplyScalar";
var dependencies27 = ["typed"];
var createMultiplyScalar = /* @__PURE__ */ factory(name27, dependencies27, (_ref) => {
  var {
    typed: typed2
  } = _ref;
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/function/arithmetic/multiply.js
var name28 = "multiply";
var dependencies28 = ["typed", "matrix", "addScalar", "multiplyScalar", "equalScalar", "dot"];
var createMultiply = /* @__PURE__ */ factory(name28, dependencies28, (_ref) => {
  var {
    typed: typed2,
    matrix: matrix2,
  ...
  return typed2(name28, multiplyScalar2, {
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/function/complex/conj.js
var name29 = "conj";
var dependencies29 = ["typed"];
var createConj = /* @__PURE__ */ factory(name29, dependencies29, (_ref) => {
  var {
    typed: typed2
  } = _ref;
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/function/matrix/concat.js
var name30 = "concat";
var dependencies30 = ["typed", "matrix", "isInteger"];
var createConcat = /* @__PURE__ */ factory(name30, dependencies30, (_ref) => {
  var {
    typed: typed2,
    matrix: matrix2,
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/function/matrix/identity.js
var name31 = "identity";
var dependencies31 = ["typed", "config", "matrix", "BigNumber", "DenseMatrix", "SparseMatrix"];
var createIdentity = /* @__PURE__ */ factory(name31, dependencies31, (_ref) => {
  var {
    typed: typed2,
    config: config4,
    matrix: matrix2,
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/utils/noop.js
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/function/matrix/size.js
var name32 = "size";
var dependencies32 = ["typed", "config", "?matrix"];
var createSize = /* @__PURE__ */ factory(name32, dependencies32, (_ref) => {
  var {
    typed: typed2,
    config: config4,
    matrix: matrix2
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/function/matrix/transpose.js
var name33 = "transpose";
var dependencies33 = ["typed", "matrix"];
var createTranspose = /* @__PURE__ */ factory(name33, dependencies33, (_ref) => {
  var {
    typed: typed2,
    matrix: matrix2
  } = _ref;
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/function/utils/numeric.js
var name34 = "numeric";
var dependencies34 = ["number", "?bignumber", "?fraction"];
var createNumeric = /* @__PURE__ */ factory(name34, dependencies34, (_ref) => {
  var {
    number: _number,
    bignumber: bignumber2,
    fraction: fraction2
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/function/arithmetic/divideScalar.js
var name35 = "divideScalar";
var dependencies35 = ["typed", "numeric"];
var createDivideScalar = /* @__PURE__ */ factory(name35, dependencies35, (_ref) => {
  var {
    typed: typed2,
    numeric: numeric2
  } = _ref;
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/function/arithmetic/add.js
var name36 = "add";
var dependencies36 = ["typed", "matrix", "addScalar", "equalScalar", "DenseMatrix", "SparseMatrix", "concat"];
var createAdd = /* @__PURE__ */ factory(name36, dependencies36, (_ref) => {
  var {
    typed: typed2,
    matrix: matrix2,
    addScalar: addScalar2,
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/function/matrix/dot.js
var name37 = "dot";
var dependencies37 = ["typed", "addScalar", "multiplyScalar", "conj", "size"];
var createDot = /* @__PURE__ */ factory(name37, dependencies37, (_ref) => {
  var {
    typed: typed2,
    addScalar: addScalar2,
    multiplyScalar: multiplyScalar2,
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/function/matrix/det.js
var name38 = "det";
var dependencies38 = ["typed", "matrix", "subtractScalar", "multiply", "divideScalar", "isZero", "unaryMinus"];
var createDet = /* @__PURE__ */ factory(name38, dependencies38, (_ref) => {
  var {
    typed: typed2,
    matrix: matrix2,
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/function/matrix/inv.js
var name39 = "inv";
var dependencies39 = ["typed", "matrix", "divideScalar", "addScalar", "multiply", "unaryMinus", "det", "identity", "abs"];
var createInv = /* @__PURE__ */ factory(name39, dependencies39, (_ref) => {
  var {
    typed: typed2,
    matrix: matrix2,
    divideScalar: divideScalar2,
...
// node_modules/.pnpm/mathjs@12.4.0/node_modules/mathjs/lib/esm/entry/pureFunctionsAny.generated.js
...
// node_modules/.pnpm/ts-gaussian@3.0.4/node_modules/ts-gaussian/dist/src/index.js
function erfc(x) {
  const z = Math.abs(x);
  const t = 1 / (1 + z / 2);
...
var Gaussian = class _Gaussian {
   ...
   */
  add(d) {
    return new _Gaussian(this.mean + d.mean, this.variance + d.variance);
  }
  /**
   ...
   */
  scale(c) {
    return new _Gaussian(this.mean * c, this.variance * c * c);
  }
  fromPrecisionMean(precision, precisionmean) {
    return new _Gaussian(precisionmean / precision, 1 / precision);
  }
};
...
// src/mathematics.ts
var SkillGaussian = class _SkillGaussian {
  /**
  ...
  mul(other) {
    ...
    return new _SkillGaussian(null, null, pi, tau);
  }
  div(other) {
    const pi = this.pi - other.pi;
    const tau = this.tau - other.tau;
...
// src/factorgraph.ts
var Variable = class extends SkillGaussian {
  messages = {};
  setVal(val) {
...
var PriorFactor = class extends Factor {
  ...
  down() {
    ...
    return this.v.updateValue(this, void 0, void 0, value);
  }
};
var LikelihoodFactor = class extends Factor {
...
var SumFactor = class extends Factor {
  constructor(sum2, terms, coeffs) {
    super([sum2].concat(terms));
    this.sum = sum2;
    this.terms = terms;
    this.coeffs = coeffs;
  }
  ...
  update(v, vals, msgs, coeffs) {
    ...
    for (let i = 0; i < vals.length; i++) {
      ...
      const div2 = val.div(msg);
      mu += coeff * div2.mu;
      if (!Number.isFinite(piInv)) {
        continue;
      }
      piInv += coeff ** 2 / div2.pi;
    }
    const pi = 1 / piInv;
    const tau = pi * mu;
...
var TruncateFactor = class extends Factor {
  ...
  up() {
    ...
    const div2 = val.div(msg);
    const sqrtPi = Math.sqrt(div2.pi);
    const v = this.vFunc(div2.tau / sqrtPi, this.drawMargin * sqrtPi);
    const w = this.wFunc(div2.tau / sqrtPi, this.drawMargin * sqrtPi);
    const denom = 1 - w;
    const pi = div2.pi / denom;
    const tau = (div2.tau + sqrtPi * v) / denom;
    return val.updateValue(this, pi, tau);
  }
};

// src/rating.ts
var Rating = class extends SkillGaussian {
...
// src/trueskill.ts
function calcDrawMargin(drawProbability, size2, env = new TrueSkill()) {
  return env.guassian.ppf((drawProbability + 1) / 2) * Math.sqrt(size2) * env.beta;
}
...
var TrueSkill = class {
   ...
   */
  rate(ratingGroups, ranks = null, weights = null, minDelta = 1e-4) {
    ...
    for (const [_x, [g, r, w]] of sorting) {
      ...
      sortedRanks.push(r);
      const max2 = w.map((ww) => Math.max(minDelta, ww));
      sortedWeights.push(max2);
    }
    const flattenRatings = sortedRatingGroups.flat();
    const flattenWeights = sortedWeights.flat();
    const size2 = flattenRatings.length;
    const fill = Array.from({ length: size2 });
    ...
    for (let idx = 0; idx < teamSizes.length; idx++) {
      const group = layers.slice(trimmed[idx], teamSizes[idx]).map((f) => new Rating(f.v.mu, f.v.sigma));
  ...
  quality(ratingGroups, weights) {
    function createVarianceMatrix(flattenRatings2, height, width) {
      const matrix2 = matrix().resize([height, width]);
      const variances = flattenRatings2.map((r) => r.sigma ** 2);
      for (let i = 0; i < variances.length; i++) {
        matrix2.set([i, i], variances[i]);
      }
      return matrix2;
    }
    function createRotatedAMatrix(newRatingGroups2, flattenWeights2) {
      let t = 0;
      let r = 0;
      const matrix2 = matrix();
      for (let i = 0; i < newRatingGroups2.length - 1; i++) {
        const setter = Array.from({ length: newRatingGroups2[i].length }, (_, n) => n + t).map((z) => {
          matrix2.set([r, z], flattenWeights2[z]);
          t += 1;
          return z;
        });
        const x = setter[setter.length - 1] + 1;
        for (let d = x; d < newRatingGroups2[i + 1].length + x; d++) {
          matrix2.set([r, d], -flattenWeights2[d]);
        }
        r++;
      }
      return matrix2;
    ...
    return exp2(eArg) * Math.sqrt(sArg);
  }
  /**
   ...
   */
  _runSchedule(ratingVars, flattenRatings, perfVars, teamPerfVars, teamSizes, flattenWeights, teamDiffVars, sortedRanks, sortedRatingGroups, minDelta = 1e-4) {
    if (minDelta <= 0) {
...
function rate_1vs1(rating1, rating2, drawn = false, minDelta = 1e-4, env = new TrueSkill()) {
  const ranks = [0, drawn ? 0 : 1];
  const teams = env.rate([[rating1], [rating2]], ranks, void 0, minDelta);
  return [teams[0][0], teams[1][0]];
}
function quality_1vs1(rating1, rating2, env = new TrueSkill()) {
  return env.quality([[rating1], [rating2]]);
}
function rate(ratingGroups, ranks, weights, minDelta = 1e-4, env = new TrueSkill()) {
